...
public class VAppManagerService extends IAppManager.Stub {
    ...
    /*
        The broadcast receiver monitors the installation/uninstallation of external applications,
        and performs corresponding actions internally (uninstalling external applications,
        uninstalling internal applications; installing external applications, updating internal applications).
        need to be blocked.
     */
